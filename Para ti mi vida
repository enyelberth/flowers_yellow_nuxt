...
<head>
    ...
    <title>Feliz 21 de septiembre❤️ ❤️</title>
...
<body>
    ...
    <div class="start-screen" id="startScreen">
        <h1 class="start-title">Un regalo para ti ❤️</h1>
    ...
    <div class="main-content animation-paused" id="mainContainer">
        ...
        <h1 class="main-title">Feliz 21 de septiembre❤️</h1>
        ...
        <section class="love-message-section">
            <div class="love-message-content">
                <h2>Mi Girasol🌻</h2>
                <p>Dicen que los girasoles buscan la luz del sol, que giran para encararlo y absorber su energía. Para mí, tú eres ese sol. No necesito buscar en el cielo, porque tu sonrisa ilumina mis días más grises y tu risa es la melodía que le da color a mi mundo. Eres la luz que guía mis pensamientos y la calidez que reconforta mi corazón.</p>
                <p>Cada momento a tu lado es como descubrir un nuevo pétalo en esta flor que es nuestro cariño: único, vibrante y lleno de vida. A veces me detengo a pensar en la suerte que tengo de haberte encontrado, de que nuestros caminos se cruzaran. Eres mi casualidad más bonita, esa que no esperaba pero que ahora no imagino mi vida sin ella.</p>
                <p>Quiero que este pequeño detalle te recuerde lo increíblemente especial que eres. Que, al igual que este girasol, tu esencia es fuerte, radiante y capaz de traer alegría a todo lo que te rodea. Gracias por ser tú, por tu paciencia, por tu cariño y por cada instante compartido.</p>
                <img src="https://www.dl.dropboxusercontent.com/scl/fi/01pulh8w6pmr1thbcctxb/flower.png?rlkey=jx0ufhpnrw07hsynrfbitkr6q&st=bzxns3c1" alt="Flor amarilla" class="footer-image">
            </div>
        </section>
    </div>
